...
impl Config {
    ...
    pub fn default_kdl() -> String {
        // TODO use `Config`s default method and serialize the structure to KDL rather than a statitc string
        //      we need to figure out how to add comments to the KDL output
...
repos "~/repos"
markdown "~/notes"
web_archives "~/Downloads/WebScrapBook"
pictures "~/pictures"
videos "~/videos"
music "~/music"
audio "~/audio"
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            web_archives: vec![PathBuf::from("~/Downloads/WebScrapBook")],
